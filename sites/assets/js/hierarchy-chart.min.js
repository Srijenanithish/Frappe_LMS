    ...
    ***************************************************************************** */
    	...
    	*/
    	...
    	expand_node(node) {
    		...
    		if (!is_sibling) {
    			...
    			var grandparent = $(("#" + (node.parent_id))).attr('data-parent');
    	...
    	load_children(node, deep) {
    		...
    		if (!deep) {
    			...
    			frappe.run_serially([
    				...
    				function () { return this$1.get_all_nodes(node.id, node.name); },
    	...
    	render_child_nodes(node, child_nodes) {
    		...
    		var current_level = $(("#" + (node.id))).parent().parent().parent().index();
    	...
    	render_child_nodes_for_expanded_view(node, child_nodes) {
    		...
    		var last_level = this.$hierarchy.find('.level:last').index();
    		var node_level = $(("#" + (node.id))).parent().parent().parent().index();
    	...
    	collapse_previous_level_nodes(node) {
    		var node_parent = $(("#" + (node.parent_id)));
    	...
    	remove_levels_after_node(node) {
    		...
    		var level = $(("#" + (node.id))).parent().parent().parent().index();
    ...
    erpnext.HierarchyChartMobile = class {
    	...
    	*/
    	...
    	remove_levels_after_node(node) {
    		var level = $(("#" + (node.id))).parent().parent().index();
